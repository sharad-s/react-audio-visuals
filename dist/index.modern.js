...
var isEmpty = (value => value === undefined || value === null || typeof value === 'object' && Object.keys(value).length === 0 || typeof value === 'string' && value.trim().length === 0);
...
var Spiral = React.forwardRef((props, ref) => /*#__PURE__*/React.createElement(App, Object.assign({
  audioRef2: ref
}, props)));
